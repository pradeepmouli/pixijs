...
| [PrepareUpload](prepareupload.md) | Part of the prepare system. Responsible for uploading all the items to the GPU.
...
| [MaskEffectManager](maskeffectmanager.md) | A class that manages the conversion of masks to mask effects. |
